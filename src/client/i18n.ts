...
export const en: Dictionary = {
      ...
      'code.language': 'Language: {language}', 'code.language.plaintext': 'Plain text',
      'code.highlightLimited': 'Content is too large, or a single line is too long, so syntax highlighting is off. The text and the existing save rules are unchanged.',
      'code.highlightUnavailable': 'Syntax highlighting is unavailable here, so the text is shown as plain text. The text is preserved, and the existing permissions and save rules are unchanged.',
      ...
      deleteDescription: 'This cannot be undone. Selected directories and all their contents will be deleted, including content added or modified while this confirmation is open.',
      ...
      'error.INVALID_DELETE_PLAN': 'The server did not confirm the selected entries and whole-directory deletion scope. No deletion was submitted.',
      ...
      uploadConflictPolicy: 'Name conflicts', uploadNewName: 'New name',
...
export const zh: Dictionary = {
      ...
      'code.language': '语言：{language}', 'code.language.plaintext': '纯文本',
      'code.highlightLimited': '内容过大或单行过长，已关闭语法着色；文本和原有保存规则保持不变。',
      'code.highlightUnavailable': '语法着色不可用，已按纯文本显示；文本保留，原有权限与保存规则不变。',
      ...
      deleteDescription: '此操作不可恢复。所选目录及其全部内容都会删除，包括确认期间新增或修改的内容。',
      ...
      'error.INVALID_DELETE_PLAN': '未取得与所选目标及删除范围一致的确认信息，没有提交删除操作。',
      ...
      uploadConflictPolicy: '重名处理', uploadNewName: '新名称',
